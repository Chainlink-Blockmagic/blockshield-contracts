...
contract TokenFactory is AccessControl, Ownable {
    ...
    event TokenRWADeployed(address indexed tokenAddress, uint256 indexed projectIndex, string name, string symbol, uint256 totalSupply, uint256 totalValue, uint256 dueDate, uint256 yield);
    event TokenInsuranceDeployed(address indexed tokenAddress, uint256 indexed projectIndex, string name, string symbol, uint256 totalSupply, uint256 dueDate, uint256 yield, uint256 prime);
